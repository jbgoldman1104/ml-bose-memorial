export const filterSectionFilters = [
  { name: 'EligiblePcp', statisticalType: 'Data - Categorical - free form' },
  { name: 'PcpMail', statisticalType: 'Data - Categorical - free form' },
  { name: 'PrimaryCareLastName', statisticalType: 'Data - Categorical - free form' },
  { name: 'MemberName', statisticalType: 'Data - Categorical - free form' },
