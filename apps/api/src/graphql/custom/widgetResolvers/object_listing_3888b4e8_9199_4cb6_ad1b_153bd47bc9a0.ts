...
// Widget: Ledger
// Thing: TransactionId
// Attributes: transactionId, transactionDate, transactionMember, transactionPcp, invoiceId, transactionAmount, memberAmountPaid, invoiceNumber, invoiceAmount, memberPaidAmount, totalDonorPayments, transactionDonor, transactionDonationAmount
// Widget type: goal
export const object_listing_3888b4e8_9199_4cb6_ad1b_153bd47bc9a0 = async (
