...
// Widget Summary
// Widget: Transaction Trends
// Value: transactionId - Total Count
// Group by: transactionDate - No Aggregation
export const widget_c1e7b0db_18b8_44f0_a7d2_93269ec834cd = async (
