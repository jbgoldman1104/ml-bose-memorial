...
// Widget Summary
// Widget: Business Donation Ratio
// Value: donorId - Total Count
// Group by: donorBusiness - No Aggregation
export const widget_6572494d_205c_4a64_af01_785b5d5ec4ea = async (
