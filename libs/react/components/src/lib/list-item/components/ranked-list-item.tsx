...
export function KsRankedListItem({ chartType, item: row, columns, metadata, widgetId }: ListItemProps) {
  const { displayColumnAttribute, displayColumnCell, rowWithId } = useListItem({ columns, item: row });
  const classes = useStyles();

  function calculatePositiveBar(value: number): CSSProperties {
  ...
  function calculateNegativeBar(value: number): CSSProperties {
