import './single-bar-highlight-max.scss';
...
import { IDeltaResults } from './single-bar-hightlight-max.model';
...
function KsSingleBarHighlightMaxBase({
  containerProps,
  translate,
  ...props
...
export const KsSingleBarHighlightMax = React.memo(
  KUIConnect(({ translate }) => ({ translate }))(KsSingleBarHighlightMaxBase),
);
