...
function KsAreaGradientBase({ context, params, ...props }: VisualizationWidgetProps & HighchartsReact.Props) {
...
export const KsAreaGradient = React.memo(KsAreaGradientBase);
