...
export class AuthClass {
  ...
  async currentAuthenticatedUser(options?: CurrentUserOptions): Promise<IUser | undefined> {
    ...
    try {
      ...
      return this.rejectAuthError(AuthErrorTypes.userNotAuthenticated, error as Error);
    }
  }
  ...
  async currentSession(): Promise<IUserSession | undefined> {
    ...
    try {
      ...
      return this.rejectAuthError(AuthErrorTypes.NoUserSession, error as Error);
    }
  }
  ...
  public async signIn({ options }: { options: SignInOptions }): Promise<IUser> {
    ...
    try {
      ...
      return this.rejectAuthError(AuthErrorTypes.Default, error as Error);
    }
  }
